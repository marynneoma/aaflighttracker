...
class searchform(forms.Form):
    flightorigin = forms.CharField(label="Fligh Origin airport code", widget=forms.TextInput(attrs={'placeholder': 'lax', 'style': 'text-transform:lowercase;'}), max_length=3, min_length=3, required=True)        # Text input for Flight Origin
